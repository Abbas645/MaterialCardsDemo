...
public class SwipeDismissRecyclerViewTouchListener implements View.OnTouchListener {
    ...
    public RecyclerView.OnScrollListener makeScrollListener() {
        return new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(int scrollState) {
                ...
                Log.d("RecyclerView", " ScrollState: " + scrollState);
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        //Log.d("RecyclerView", "Touched View: " + view.toString() + " motionEvent: " + motionEvent.getActionMasked());
        ...
        switch (motionEvent.getActionMasked()) {
            case MotionEvent.ACTION_DOWN: {
                if (mPaused) {
                    Log.d("RecyclerView", "Paused: " + mPaused);
                    return false;
                }
                ...
                Log.d("RecyclerView Child" , mDownView + " ");
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                Log.d("RecyclerView", "mVelocityTracker: " + mVelocityTracker + " mPaused: " + mPaused);
